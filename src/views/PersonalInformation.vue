     ...
     <div class="w-1/2">
       ...
       <div class="mt-1">
         <div class="" v-if="OpenIcon === true">
           <SuccessIcon class="text-green-500 absolute  mt-5 w-1/3 ml-28"></SuccessIcon>
         </div>
         <input
             v-model="inputValue"
             type="text"
     ...
     <div class="w-full">
       ...
       <div class="mt-3">
         <div class=""  v-if="PhoneIcon === true">
           <SuccessIcon class="text-green-500 absolute mt-5 ml-12 w-11/12 "></SuccessIcon>
         </div>
         <input
             v-model="phone"
             type="text"
  ...
  methods: {
    PersonalInfoValidation() {
      ...
      if (this.inputValue !== '' && this.lastname!== '' && file_upload.name !== '' && this.mailAction === true && this.phone !== ''){
        let photoBlob = new Blob([this.$refs.photo.files[0]], { type: this.$refs.photo.files[0].type });
    ...
    previewImage(){
      ...
      let str_data  = File[this.$refs.photo.files[0],this.$refs.photo.files[0].name];
